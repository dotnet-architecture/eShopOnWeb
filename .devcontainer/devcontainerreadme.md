...
* Since the dev container is Linux-based, you won't be able to use LocalDB. Follow the [steps from the readme](../README.md#configuring-the-sample-to-use-sql-server) to configure the sample to use SQL Server.
